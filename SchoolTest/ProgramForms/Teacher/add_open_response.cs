...
namespace SchoolTest.ProgramForms.Teacher
{
    public partial class add_open_response : Form
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            authApi.path = "open_response_add";

            var classObject2 = new
            {
                response_id = response_id,
                correct_response = correct_responseTextBox.Text,
            };
        ...
        private void add_open_response_FormClosed(object sender, FormClosedEventArgs e)
        {
            buttonBack_Click(sender, e);
        }

        private void add_open_response_Load(object sender, EventArgs e)
        {
            ...
            correct_responseTextBox.Text = dataTable.correct_response;
        }
    }
}
